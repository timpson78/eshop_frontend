<template>
  <div class="card-carousel" @mouseover="stopTimer" @mouseleave="restartTimer">
    ...
    <div class="card-img">
      <div class="card-img" >
         <img :src="currentImage" alt=""  style = "height: 100%; object-fit: cover">
      </div>
      <div class="actions">
                    <span @click="prevImage" >
                        <!--<i class="fas fa-chevron-left"></i>-->
                      <v-icon large class="left_right_arrow">mdi-chevron-left</v-icon>
                    </span>
        <span @click="nextImage" >
                        <!--<i class="fas fa-chevron-right"></i>-->
                     <v-icon large class="left_right_arrow">mdi-chevron-right</v-icon>
                    </span>
      </div>
    </div>
